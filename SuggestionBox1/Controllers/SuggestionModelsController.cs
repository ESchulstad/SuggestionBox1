...
using SuggestionBox1.Models;

namespace SuggestionBox1.Controllers
{
    public class SuggestionModelsController : Controller
    {
        private SuggestionBox1Context db = new SuggestionBox1Context();
        ...
        public ActionResult Create([Bind(Include = "RecordNum,Topic,Suggestion,UserName")] SuggestionModel suggestionModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,Topic,Suggestion,UserName")] SuggestionModel suggestionModel)
        {
            if (ModelState.IsValid)
            {
